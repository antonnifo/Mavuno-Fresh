JAZZMIN_SETTINGS = {
    # title of the window
    'site_title': 'Mavuno Fresh Admin',

    # Title on the brand, and the login screen (19 chars max)
    'site_header': 'Mavuno Fresh',

    # square logo to use for your site, must be present in static files, used for favicon and brand on top left
    # 'site_logo': 'shop/img/favicon.png',

    # Welcome text on the login screen
    'welcome_sign': 'Welcome to Mavuno Fresh',

    # Copyright on the footer
    'copyright': 'Mavuno Fresh',

    # The model admin to search from the search bar, search bar omitted if excluded
    # 'search_model': 'auth.User',
    'search_model': 'Mavuno.Product', 'Mavuno.Category'
    ...
    'icons': {
        ...
        'shop.Product': 'fas fa-hands-helping',
        'shop.Category': 'fas fa-hands-helping',
    },
